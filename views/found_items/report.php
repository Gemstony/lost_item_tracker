...
<div class="container-fluid">
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <form action="<?= BASE_URL ?>index.php?page=found_items/report" method="POST" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="found_location" name="found_location" class="form-control" required>
